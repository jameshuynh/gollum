        ...
        editorBody.ondrop = function(e) {
          ...
          $.ajax({
            ...
            success: function(){
              ...
              editorBody.focus();
              var fileStr = '[[' + uploadDest + '/' + file.name + ']]';
              // $editorBody.append('[[' + uploadDest + '/' + file.name + ']]');
              // document.execCommand('insertText', false, '[[' + uploadDest + '/' + file.name + ']]');
              $editorBody.val($editorBody.val() + fileStr);
            },
